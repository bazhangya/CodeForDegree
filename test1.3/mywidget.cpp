    ...
    ui(new Ui::MyWidget)
{
    ...
    maxY = 6000;
    QSplineSeries_hall = new QSplineSeries();
    QSplineSeries_hall2 = new QSplineSeries();
    ...
    QSplineSeries_coil = new QSplineSeries();//防止锯齿//QChart_coil->scroll(mx,my) mx my是x y轴的滚动量 QSplineSeries_coil->removePoints()
    QSplineSeries_coil2 = new QSplineSeries();
